        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <TouchableOpacity style={styles.button}>
                    <Text style={styles.buttonText}>카드사 무이자 할부</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={styles.receiptHeader}>
                ...
                <Text style={styles.smallGrayText}>(휴대폰, 이메일 입력시 매출전표 발송)</Text>
            </View>
            <View style={styles.separator} />
            ...
            <View style={styles.inputGroup}>
                <View>
                    ...
                    <TextInput style={styles.input} keyboardType="email-address" value={email} onChangeText={(text) => {
                        setEmail(isValidEmail(text));}} placeholder="이메일 주소를 입력하세요." maxLength={64}/>
